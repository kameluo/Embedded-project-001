...
u8 DIO_u8GetPinValue(u8 Copy_u8PinIndx)
{
	u8 Local_u8Result ;
	//u8 Local_u8Resultt = 0 ;
	if((Copy_u8PinIndx >= DIO_u8_PORTA_START) && (Copy_u8PinIndx <= DIO_u8_PORTA_END))
	{
		if(GETBIT(PINA, Copy_u8PinIndx))
		{
